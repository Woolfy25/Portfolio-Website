...
// import Lottie from "react-lottie"; // ! ADD
...
//       style={{
//         background:
//           "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(41,19,61,1) 100%)",
//       }}
//     >
//       <div className={`${id === 6 && "flex justify-center h-full"}`}>
//         <div className="w-full h-full absolute">
...
//         {id === 6 && (
//           <BackgroundGradientAnimation>
//             <div className="absolute z-15 flex items-center justify-center text-white font-bold" />
//           </BackgroundGradientAnimation>
//         )}
//         <div
//           className={cn(
